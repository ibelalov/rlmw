...
3. Defer the frozen manifest, calibration evidence, replicated experiments, neural-quality comparisons, and RL-quality comparisons to later staged PRs until v2 is reviewed, calibrated, and frozen.
