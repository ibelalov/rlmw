...
3. After PR #59 candidate tooling, complete a focused stronger solver-disabled ISD baseline PR before external generation/calibration; defer PR C frozen-manifest review, later replicated classical evaluation, neural-quality comparisons, and RL-quality comparisons to later staged PRs until v2 is reviewed, calibrated, and frozen.
